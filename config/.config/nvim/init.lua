    ...
    config = function()
      ...
      cmp.setup({
        ...
        mapping = cmp.mapping.preset.insert({
          ...
          ["<CR>"] = cmp.mapping.confirm({ -- zbirenbaum/copilot-cmp
    ...
    config = function()
      require('bufferline').setup({
        ...
        highlights = {
            ...
            background = { bg = 'none' },
            tab = { bg = 'none' },
            tab_selected = { fg = { highlight = 'Normal', attribute = 'fg' }, bg = 'none', italic = false, bold = true },
            tab_close = { bg = 'none' },
            tab_separator = { fg = '#262a3f', bg = 'none' },
            tab_separator_selected = { fg = '#262a3f', bg = 'none' },
            ...
            modified = { fg = { highlight = 'Comment', attribute = 'fg' }, bg = 'none' },
            modified_visible = { fg = { highlight = 'Comment', attribute = 'fg' }, bg = 'none' },
            modified_selected = { fg = { highlight = 'Normal', attribute = 'fg' }, bg = 'none', italic = true, bold = true },
            duplicate_selected = { bg = 'none', italic = false, bold = true },
            duplicate_visible = { bg = 'none' },
            duplicate = { bg = 'none' },
            separator_selected = { fg = '#262a3f', bg = 'none' },
            separator_visible = { fg = '#262a3f', bg = 'none' },
            separator = { fg = '#262a3f', bg = 'none' },
