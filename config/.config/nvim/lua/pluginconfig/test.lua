...
local actions = {
  suite = function() require('nvim-test').run('suite') end,
  file = function() require('nvim-test').run('file') end,
  nearest = function() require('nvim-test').run('nearest') end,
  visit = function() require('nvim-test').visit() end,
}
